                                        ...
                                        <div class="card-body">
                                            <div class="mx-n3" data-simplebar style="max-height: 478px;">
                                                <div class="d-flex gap-2 mb-3">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-body-secondary rounded">
                                                            <img src="{{asset('/')}}admin/assets/images/brands/chrome.png" alt="" class="avatar-xxs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex gap-2 mb-3">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-body-secondary rounded">
                                                            <img src="{{asset('/')}}admin/assets/images/brands/firefox.png" alt="" class="avatar-xxs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex gap-2 mb-3">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-body-secondary rounded">
                                                            <img src="{{asset('/')}}admin/assets/images/brands/cloud-computing.png" alt="" class="avatar-xxs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex gap-2 mb-3">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-body-secondary rounded">
                                                            <img src="{{asset('/')}}admin/assets/images/brands/safari.png" alt="" class="avatar-xxs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex gap-2 mb-3">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-body-secondary rounded">
                                                            <img src="{{asset('/')}}admin/assets/images/brands/opera.png" alt="" class="avatar-xxs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex gap-2 mb-3">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-body-secondary rounded">
                                                            <img src="{{asset('/')}}admin/assets/images/brands/microsoft.png" alt="" class="avatar-xxs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-body-secondary rounded">
                                                            <img src="{{asset('/')}}admin/assets/images/brands/chromium.png" alt="" class="avatar-xxs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                        ...
                        <div class="d-none d-xl-block">
                            <div class="card bg-success-subtle shadow-none rounded-0 border-0 dashboard-widgets-wrapper">
                                <div class="card-body text-center mt-5 pt-5">
                                    ...
                                    <img src="{{asset('/')}}admin/assets/images/dashboard.png" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
