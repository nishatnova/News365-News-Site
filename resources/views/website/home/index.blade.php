        ...
        <div class="row row-margin">
            ...
            <div class="col-sm-3 hidden-xs col-padding">
                ...
                <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                    <div class="post-thumb img-zoom-in">
                        <a href="{{route('blog-detail',['id' => $last_post->id])}}">
                            <img class="entry-thumb" src="{{asset($last_post->image)}}" alt="">
                        </a>
                    </div>
                    <div class="post-info">
                        <div class="slide">
                            <a target="_blank" href="#" class="post-badge btn_three">Latest</a>
                        </div>
                        <span class="color-5"><br>{{$last_post->category->name}} </span>
                        <h3 class="post-title post-title-size"><a href="{{route('blog-detail',['id' => $last_post->id])}}" rel="bookmark"> {{$last_post->title}}</a></h3>
                        <div class="post-editor-date">
                            <!-- post date -->
                            <div class="post-date">
                                <i class="pe-7s-clock"></i> {{$last_post->created_at->diffForHumans()}}
                            </div>
                            <!-- post comment -->
                            ...
                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                                <div class="post-thumb img-zoom-in">
                                    <a href="{{route('blog-category', ['id' => $category->id])}}">
                                        <img class="entry-thumb" src="{{asset($category->image)}}" alt="">
                                    </a>
                                </div>
                                <div class="post-info">
                                    ...
                                    <div class="post-editor-date">
                                        ...
                                        <div class="post-author-comment"><h3 class="color-1 post-title "><a href="" class="color-5" rel="bookmark"> {{$category->name}}</a></h3></div>
            ...
            <div class="col-sm-3 hidden-xs col-padding">
                ...
                <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                    ...
                    <div class="post-thumb img-zoom-in">
                        <a href="{{route('blog-detail',['id' => $sec_last_post->id])}}">
                            <img class="entry-thumb" src="{{asset($sec_last_post->image)}}" alt="">
                        </a>
                    </div>
                    <div class="post-info">
                        ...
                        <span class="color-5"><br>{{$sec_last_post->category->name}}</span>
                        <h3 class="post-title post-title-size"><a href="{{route('blog-detail',['id' => $sec_last_post->id])}}" rel="bookmark">{{$sec_last_post->title}}</a></h3>
                        <div class="post-editor-date">
                            <!-- post date -->
                            <div class="post-date">
                                <i class="pe-7s-clock"></i> {{$sec_last_post->created_at->diffForHumans()}}
                            </div>
                            <!-- post comment -->
                            <div class="post-author-comment"><i class="pe-7s-comment"></i>    </div>
                            <!-- read more -->
...
<div class="container">
    <div class="row">
                                    ...
                                    <div class="post-wrapper post-grid-8 wow fadeIn" data-wow-duration="2s">
                                        <div class="post-thumb img-zoom-in">
                                            <a href="{{route('blog-detail',['id' => $blog->id])}}">
                                                <img height="300" class="entry-thumb-bottom" src="{{asset($blog->image)}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-info">
                                            <span class="color-4">{{$blog->category->name}}</span>
                                            <h3 class="post-title post-title-size"><a href="{{route('blog-detail',['id' => $blog->id])}}" rel="bookmark">{{$blog->title}} </a></h3>
                                            <div class="post-editor-date">
                                                <!-- post date -->
                                                <div class="post-date">
                                                    <i class="pe-7s-clock"></i> {{$blog->created_at}}
                                                </div>
                                                <!-- post comment -->
                                                <div class="post-author-comment"><i class="pe-7s-comment"></i> </div>
                                                <!-- read more -->
        ...
        <section class="recent_news_inner">
                        ...
                        <div class="item">
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img height="250" class="img-responsive" src="{{asset($blog->image)}}" alt="">
                                    </a>
                                </div>
                                <div class="post-info meta-info-rn">
                                    <div class="slide">
                                        <a target="_blank" href="#" class="post-badge btn_six">{{$blog->category->name}}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="post-title-author-details">
                                <div class="post-editor-date">
                                    <div class="post-date">
                                        <i class="pe-7s-clock"></i> {{$blog->created_at->diffForHumans()}}
                                    </div>
                                    <div class="post-author-comment"><i class="pe-7s-comment"></i>  </div>
                                </div>
                                <p>Various versions have evolved<a href="{{route('blog-detail',['id' => $blog->id])}}">Read more...</a></p>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="row rn_block">
                    ...
                    <div class="col-md-4 col-sm-6 hidden-sm padd">
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                            ...
                            <div class="post-info meta-info-rn">
                                <div class="slide">
                                    <a target="_blank" href="#" class="post-badge btn_one">{{$blog->category->name}}</a>
                                </div>
                            </div>
                        </div>
                        <div class="post-title-author-details">
                            <h4><a href="{{route('blog-detail',['id' => $blog->id])}}">Various versions have evolved over the years, ...</a></h4>
                            <div class="post-editor-date">
                                <div class="post-date">
                                    <i class="pe-7s-clock"></i> {{$blog->created_at}}
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                                        ...
                                        <div class="post-thumb">
                                            <a href="#">
                                                <img src="{{asset('/')}}website/images/politics_01.jpg" class="img-responsive" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="post-title-author-details">
                                    ...
                                    <div class="row rn_block">
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                                                <a href="#">
                                                    <img src="{{asset('/')}}website/images/politics_02.jpg" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
                                                <!-- post image -->
                                        ...
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                <a href="#">
                                                    <img src="{{asset('/')}}website/images/politics_03.jpg" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
                                                <!-- post image -->
                                        ...
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                                <a href="#">
                                                    <img src="{{asset('/')}}website/images/politics_04.jpg" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
                                                <!-- post image -->
                                        ...
                                        <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                            ...
                                            <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                                <a href="#">
                                                    <img src="{{asset('/')}}website/images/politics_05.jpg" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="post-title-author-details">
                                                <!-- post image -->
            ...
            <!-- /.Politics -->
            <div class="ads">
                <a href="#"><img src="{{asset('/')}}website/images/top-bannner2.jpg" class="img-responsive center-block" alt=""></a>
            </div>
        </div>
        <!-- /.left content inner -->
            ...
            <div id="content-slide-4" class="owl-carousel">
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{asset('/')}}website/images/weekly-news-01.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{asset('/')}}website/images/weekly-news-05.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{asset('/')}}website/images/weekly-news-02.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{asset('/')}}website/images/weekly-news-03.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{asset('/')}}website/images/weekly-news-04.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="item">
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb" src="{{asset('/')}}website/images/weekly-news-06.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="buisness">
                            ...
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img src="{{asset('/')}}website/images/business-01.jpg" class="img-responsive" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="post-title-author-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('/')}}website/images/business-02.jpg" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('/')}}website/images/business-03.jpg" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                                    <h3 class="td-module-title"><a href="#">Lorem Ipum therefore always free from repetition</a></h3>
                                    <div class="post-editor-date">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="international">
                            ...
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                ...
                                <div class="post-thumb">
                                    <a href="#">
                                        <img src="{{asset('/')}}website/images/international.jpg" class="img-responsive" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="post-title-author-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('/')}}website/images/international-2.jpg" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                                    <h3 class="td-module-title"><a href="#">Lorem Ipum therefore always free from repetition</a></h3>
                                    <div class="post-editor-date">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('/')}}website/images/international-3.jpg" alt="" height="70" width="100"></a>
                                </div>
                                <div class="item-details">
                                    <h3 class="td-module-title"><a href="#">Lorem Ipum therefore always free from repetition</a></h3>
                                    <div class="post-editor-date">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img src="{{asset('/')}}website/images/technology/tecnology-01.jpg" class="img-responsive" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="post-title-author-details">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="row rn_block">
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                    <a href="#">
                                                        <img src="{{asset('/')}}website/images/technology/tecnology-02.jpg" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
                                                    <!-- post image -->
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                                    <a href="#">
                                                        <img src="{{asset('/')}}website/images/technology/tecnology-03.jpg" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
                                                    <!-- post image -->
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                                    <a href="#">
                                                        <img src="{{asset('/')}}website/images/technology/tecnology-04.jpg" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
                                                    <!-- post image -->
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                ...
                                                <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                                                    <a href="#">
                                                        <img src="{{asset('/')}}website/images/technology/tecnology-05.jpg" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-title-author-details">
                                                    <!-- post image -->
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="sports-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{asset('/')}}website/images/sports.jpg" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="fashion-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{asset('/')}}website/images/fashion.jpg" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="travel-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{asset('/')}}website/images/travel.jpg" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="food-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{asset('/')}}website/images/food.jpg" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="politics-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{asset('/')}}website/images/politics_06.jpg" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="health-inner">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                        ...
                        <div class="post-thumb">
                            <a href="#">
                                <img src="{{asset('/')}}website/images/health.jpg" class="img-responsive" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="post-title-author-details">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                <!-- article -->
                <div class="add_logo">
                    <a href="#"><img src="{{asset('/')}}website/images/top-bannner2.jpg" class="img-responsive" alt=""></a>
                </div>
                        ...
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    ...
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-01.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-02.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-03.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-04.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-05.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-06.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-07.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-08.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-09.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-10.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-11.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div>
                                <div class="prettyPhoto">
                                    <div class="fp-overlay"><i class="fa fa-mail-forward"></i></div>
                                    <a href="#"><img src="{{asset('/')}}website/images/flicker/flicker-12.jpg" class=" popup img-responsive" alt=""></a>
                                </div>
                            </div>
                        </li>
                    </ul>
